...
var BgImgHolder = function() {
    ...
    a.length && a.each(function() {
        ...
        t = a.data("bg-position") ? a.data("bg-position") : "initial",
        n = a.data("bg-size") ? a.data("bg-size") : "auto",
        o = a.data("bg-height") ? a.data("bg-height") : "100%",
        a.css("background-image", 'url("' + e + '")').css("background-position", t).css("background-size", n).css("opacity", "1").css("height", o)
    })
}()
  , CardActions = function() {
    ...
    a.length && $(n).length && (a.on({
        mouseenter: function() {
            ...
            e.length && (e.addClass("in animated " + t),
    ...
    a.on({
        mouseleave: function() {
            ...
            e.length && (e.addClass("animated " + t),
            e.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
    ...
    c.fn.countTo = function(d) {
        ...
        c(this).each(function() {
            ...
            r.interval = setInterval(function() {
                i++,
                l(s += e),
                "function" == typeof t.onUpdate && t.onUpdate.call(n, s),
                a <= i && (o.removeData("countTo"),
                clearInterval(r.interval),
                s = t.to,
                "function" == typeof t.onComplete && t.onComplete.call(n, s))
            }, t.refreshInterval),
            l(s)
        })
    }
...
var map, lat, lng, CountTo = function() {
    ...
    a.length && a.each(function() {
        ...
        s.on("change", function(a) {
            ...
            o = s.next("label"),
            i = o.html(),
            e && 1 < e.files.length ? n = (e.getAttribute("data-multiple-caption") || "").replace("{count}", e.files.length) : t.target.value && (n = t.target.value.split("\\").pop()),
...
var Highlight = function() {
  ...
  , Layout = void $("body").on("click", "[data-action]", function(a) {
    ...
    case "search-open":
        ...
        e.addClass("active"),
        $(n).addClass("show"),
        $("body").addClass("navbar-search-open").append('<div class="body-backdrop body-backdrop-dark" data-action="search-close" data-target="' + n + '" />');
        break;
    case "search-close":
        n = e.data("target"),
  ...
  , NavbarCollapse = function() {
    ...
    e.length && (e.on({
        "show.bs.collapse": function() {
            ...
            t.addClass("navbar-collapsed")
        }
    }),
    e.on({
        "hide.bs.collapse": function() {
            e.removeClass("collapsing").addClass("collapsing-out"),
            a.removeClass("navbar-collapsed").addClass("navbar-collapsed-out"),
            t.removeClass("navbar-collapsed").addClass("navbar-collapsed-out")
        }
    }),
    e.on({
        "hidden.bs.collapse": function() {
            ...
            t.removeClass("navbar-collapsed-out")
        }
    }))
}()
    ...
    $(window).on({
        "load resize": function() {
            a.length && a.each(function() {
                var a, e;
                a = $(this),
                e = a.find($(a.data("negative-margin"))).height(),
                console.log(e),
  ...
  , SingleSlider = function() {
    ...
    a.length && a.each(function() {
        ...
        a = $(this),
        e = a.find(".input-slider"),
        t = e.attr("id"),
        n = e.data("range-value-min"),
        o = e.data("range-value-max"),
        i = a.find(".range-slider-value"),
        s = i.attr("id"),
        ...
        l.noUiSlider.on("update", function(a, e) {
            d.textContent = a[e]
        })
    })
}()
    ...
    a.length && e.on({
        click: function() {
            !function(a) {
                ...
                a.hasClass("active") || ($("." + e.attr("class") + " button[data-pricing]").removeClass("active"),
                a.addClass("active"),
                t.each(function() {
